const slideList = [{
    img: "img/mount-everest.jpg",
    text: "Każdy ma swój Everest",
    p: "/ Tenzing /"
  },
  {
    img: "img/top.jpg",
    text: "Ważne jest nie samo osiągnięcie wierzchołka, lecz droga do niego.",
    p: "Joe Tasker"
  },
  {
    img: "img/travel.jpg",
    text: "Świat jest książką i ci, którzy nie podróżują, czy­tają tyl­ko jedną stronę ",
    p: "św. Augustyn"
  }
];
